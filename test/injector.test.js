...
var util = require('util')
  , injectorContainer = require('../lib/injector')
  , annotate = injectorContainer.annotate;
...
//   s6
  ...
  it('should have $injector', function() {
    var $injector = container.createInjector();
  ...
  it('should define module', function() {
    var log = '';
    var injector = container.createInjector([function($provide) {
  ...
  describe('module', function() {
    it('should provide $injector even when no module is requested', function() {
      var $provide,
        $injector = container.createInjector([
          extend(function(p) { $provide = p; }, {$inject: ['$provide']})
        ]);
      expect($injector.get('$injector')).toBe($injector);
    });
    ...
    it('should error on invalid module name', function() {
      expect(function() {
        container.createInjector(['IDontExist'], {});
    ...
    it('should load dependant modules only once', function() {
      var log = '';
      container.module('a', [], function(){ log += 'a'; });
      container.module('b', ['a'], function(){ log += 'b'; });
      container.module('c', ['a', 'b'], function(){ log += 'c'; });

      container.createInjector(['c', 'c']);
      expect(log).toEqual('abc');
    });

    it('should execute runBlocks after injector creation', function() {
      var log = '';
      container.module('a', [], function(){ log += 'a'; }).run(function() { log += 'A'; });
      container.module('b', ['a'], function(){ log += 'b'; }).run(function() { log += 'B'; });
    ...
    describe('$provide', function() {
      ...
      describe('value', function() {
        it('should configure $provide values', function() {
          expect(container.createInjector([function($provide) {
      ...
      describe('service', function() {
        it('should register a class', function() {
          ...
          var instance = container.createInjector([function($provide) {
      ...
      describe('decorator', function() {
        ...
        it('should be called with the original instance', function() {
          injector = container.createInjector([function($provide) {
    ...
    describe('error handling', function() {
      ...
      it('should handle exceptions', function() {
        expect(function() {
          container.createInjector([function() {
            throw 'MyError';
          }], {});
        }).toThrow('MyError');
      });
      ...
      it('should decorate the missing service error with module name', function() {
        container.module('TestModule', [], function(xyzzy) {});
        expect(function() {
          container.createInjector(['TestModule']);
      ...
      it('should decorate the missing service error with module function', function() {
        ...
        expect(function() {
          container.createInjector([myModule]);
  ...
  describe('retrieval', function() {
    ...
    beforeEach(function() {
      $injector = container.createInjector([ ['$provide', function(provide) {
