...
initNode($tree, $node)  -> add stuff to the event loop

INPUT -> PARSE -> BUILD TREE -> FIND DEPS -> EXECUTE PIPELINE

website -> transform

post,get,xyz

create widgets (content editiable) {this will come from the database}
lang pages
...
var ctx = injector();
ctx.module('demi', [], function($provide) {
